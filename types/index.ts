...
export interface Frame {
  ...
  frameStyle: 'round' | 'square' | 'aviator' | 'cat-eye' | 'rectangle' | 'wayfarer' | 'clubmaster';
  ...
  lensCompatible: Array<'single-vision' | 'blue-cut' | 'progressive' | 'photochromic' | 'anti-glare'>;
